    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-8 space-y-8">
        ...
        <div className="border-b border-border pb-6">
          ...
          <h1 className="text-2xl font-bold text-foreground">Gerenciar recursos</h1>
                  ...
                  <div key={p.id} className="rounded border border-border">
                    {editingProfId === p.id ? (
                      ...
                      <div className="flex items-center gap-3 px-3 py-2.5 group">
                        <div className="w-8 h-8 rounded bg-foreground text-background flex items-center justify-center text-xs font-bold shrink-0">
                          {getInitial(p.nome)}
                        </div>
